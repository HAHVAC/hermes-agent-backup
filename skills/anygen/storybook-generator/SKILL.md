...
✅ **Correct working command for AnyGen v0.1.0**:
```bash
anygen task create --data '{"operation":"storybook","prompt":"your prompt here","lang":"vi"}'
```

Use this exact command, the generic `generate` command **does not exist** in the public CLI version.
